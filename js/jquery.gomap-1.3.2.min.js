...
jQuery(document).ready(function() {
	// initiate googlemaps					
    jQuery('#map').goMap({ address: '15 Rue de la Mairie, Nagel-Séez-Mesnil, France',
	    	zoom: 15,
	    	navigationControl: true, 
	    	maptype: 'TERRAIN',
	    	draggable: true, zoomControl: true, scrollwheel: true, disableDragging: true,
	    	markers: [
	    		{ 'address' : '15 Rue de la Mairie, Nagel-Séez-Mesnil, France' }
	    	],
